               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="hero-cap text-center pt-50">
                           <h2>{{$kategori->wisata->nama_wisata}}</h2>
                     </div>
                  </div>
               </div>
         </div>
               ...
               <div class="col-lg-8 posts-list">
                  <div class="single-post">
                     <div class="feature-img">
                        <img class="img-fluid" src="{{ $kategori->image() }}" alt="" width="1800px">
                     </div>
                     <div class="blog_details">
                        <h2>{{$kategori->wisata->nama_wisata}}
                        </h2>
                        <h4>Alamat: {{$kategori->wisata->alamat}}
                        </h4>
                        <p class="excert">
                          {{$kategori->wisata->deskripsi}}
                        </p>
                     </div>
                  </div>
      <!--================ Blog Area end =================-->
