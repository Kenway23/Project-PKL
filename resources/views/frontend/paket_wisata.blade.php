...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <main>
        ...
        <a href="{{ route('wisatauser.show',$data->id) }}" class="btn btn-primary" style="width: 18rem; height: 20px;">Lihat Detail</a>
        </div>
        </div>
        @endforeach
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-tittle text-center mb-80">
                            <h2>Top 3 Tempat Wisata Terfavorit </h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{asset('assets2/img/wisata/tebingkeraton.jpg')}}" style="width: 25rem; height: 300px;" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30"> , 
                            <div class="location-img">
                                <img src="{{asset('assets2/img/wisata/masjidagung.jpg')}}" alt="">
                            </div>
                            <div class="location-details">
                                <p>Masjid Agung</p>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{asset('assets2/img/wisata/culturepark.jpg')}}" alt="">
                            </div>
                            <div class="location-details">
